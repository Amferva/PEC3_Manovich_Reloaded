...
Se utilizó *Apple's Xcode* para conseguir el efecto deseado de realidad. Además, tenía que tener compatibilidad con iOS para desarrollarse. Aprovecharón las funciones que los iPad tienen, cómo por ejemplo, los efectos de rotación e inclinación de pantalla para crear efectos como el movimiento de objetos o que los personajes se balancen de manera realista. 
